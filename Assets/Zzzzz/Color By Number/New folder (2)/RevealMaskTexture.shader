    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                half4 highlightColor = tex2D(_Highlight, i.uv);  // Highlight texture
                ...
                if (!isOutline) // Only modify non-outline pixels
                {
                    ...
                    if (baseColor.a > 0.5)
                    {
                        finalColor = maskColor; // Use the mask color if the region is filled
                        numberColor.a = 0.0;    // Hide the number texture once the region is filled
                    }
                }
